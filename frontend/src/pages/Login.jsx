...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
      <div className="absolute w-[500px] h-[500px] bg-red-600/20 rounded-full blur-3xl top-[-10%] left-[-10%]" />
      <div className="absolute w-[400px] h-[400px] bg-red-700/10 rounded-full blur-3xl bottom-[-10%] right-[-10%]" />

      <svg viewBox="0 0 400 400" className="absolute w-[500px] h-[500px] opacity-40 pointer-events-none">
        <motion.line x1="60" y1="80" x2="200" y2="50" stroke="#ef4444" strokeWidth="1" strokeDasharray="4 4"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, delay: 0.2 }} />
        <motion.line x1="200" y1="50" x2="330" y2="150" stroke="#ef4444" strokeWidth="1" strokeDasharray="4 4"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, delay: 0.5 }} />
        <motion.line x1="60" y1="80" x2="90" y2="300" stroke="#ef4444" strokeWidth="1" strokeDasharray="4 4"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, delay: 0.8 }} />
        <motion.line x1="330" y1="150" x2="300" y2="340" stroke="#ef4444" strokeWidth="1" strokeDasharray="4 4"
          initial={{ pathLength: 0 }} animate={{ pathLength: 1 }} transition={{ duration: 1.5, delay: 1.1 }} />
      </svg>

      {[
        { top: "12%", left: "10%", delay: 0 },
        { top: "8%", left: "78%", delay: 0.6 },
        { top: "80%", left: "18%", delay: 1.2 },
        { top: "75%", left: "82%", delay: 1.8 },
      ].map((pos, i) => (
        <motion.div
          key={i}
      ...
      >
        ...
        <p className="text-zinc-500 text-sm mb-6">Log in to continue chatting</p>
